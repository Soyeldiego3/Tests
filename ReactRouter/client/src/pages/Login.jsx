      ...
      <div className='p-3 bg-white w-25'>
        ...
        <form onSubmit={handleSubmit} className='d-flex flex-column text-center align-items-center'>
          <div className='mb-4 w-100'>
            <input id='email' type="text" placeholder='Correo Electronico' className='form-control border border-black' //cambiar "type" para solo pedir "email" y dar el aviso de falta email
